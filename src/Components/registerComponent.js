...
class RegisterComponent extends React.Component {
  ...
  componentDidMount() {
    //this.props.RegisterAction.register();
  }
  ...
  employeeSubmit(e) {
    ...
    console.log("after submited data>>>>>",JSON.stringify(data));
                                ...
                                <div className="row register-form">
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <input type="text" className="form-control" placeholder="First Name *" defaultValue="" onChange={this.firstname} />
                                        </div>
                                        <div className="form-group">
                                            <input type="text" className="form-control" placeholder="Last Name *" defaultValue="" onChange={this.lastname} />
                                        </div>
                                        <div className="form-group">
                                            <input type="password" className="form-control" placeholder="Password *" defaultValue="" onChange={this.password} />
                                        </div>
                                        <div className="form-group">
                                            <input type="password" className="form-control"  placeholder="Confirm Password *" defaultValue="" onChange={this.cpassword} />
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="form-group">
                                            <input type="email" className="form-control" placeholder="Your Email *" defaultValue="" onChange={this.emailchange}/>
                                        </div>
                                        <div className="form-group">
                                            <input type="text" minLength="10" maxLength="10" className="form-control" placeholder="Your Phone *" defaultValue=""  onChange={this.phonechange} />
                                        </div>
                                        <div className="form-group">
                                            <select className="form-control" onChange={this.question}>
                                                <option defaultValue="" className="hidden" disabled>Please select your Sequrity Question</option>
                                                <option defaultValue="What is your Birthdate?">What is your Birthdate?</option>
                                                <option defaultValue="What is Your old Phone Number">What is Your old Phone Number</option>
                                                <option defaultValue="What is your Pet Name?">What is your Pet Name?</option>
                                            </select>
                                        </div>
                                        <div className="form-group">
                                            <input type="text" className="form-control" placeholder="Enter Your Answer *" defaultValue="" onChange={this.answer} / >
                                        </div>
                                        <input type="submit" className="btnRegister"  defaultValue="Register" onClick={this.employeeSubmit}/>
                                    </div>
                                </div>
                                </form>
                            </div>
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <div className="form-group">
                                            <select className="form-control">
                                                ...
                                                <option defaultValue="1">What is your Birthdate?</option>
                                                <option  defaultValue="2">What is Your old Phone Number</option>
